...
async function seed() {
  ...
  try {
    ...
    if (fs.existsSync(wingasPath)) {
      ...
      console.log('ℹ️ wingas.json not found, skipping...');
    }
    ...
    if (fs.existsSync(productsPath)) {
      ...
      console.log('ℹ️ products.json not found, skipping...');
    }
    ...
    if (fs.existsSync(ordersPath)) {
      ...
      console.log('ℹ️ orders.json not found, skipping...');
    }
    ...
    if (fs.existsSync(reviewsPath)) {
      ...
      console.log('ℹ️ reviews.json not found, skipping...');
    }
